class Dimens {
  ...
  static const double tabBarDefaultHeight = 40;
  static const double tabBarAboutCompanyHeight = 42;
  static const double logoWidth = 122;
  static const double heightContainerEmployeeStats = 156;
  static const double modalHeightRecruiterDetail = 200;
  static const double modalHeightNotifications = 350;
  static const double modalHeightDiscountDetail = 350;
  static const double heightMarketStatsChart = 380;
  static const double maxVideoHeight = 400;
  ...
  static const int maxLines6 = 6;
  static const int maxLines10 = 10;

  static const double scrollStartPos = 0.0;

  static const double aspectRatio18to9 = 18 / 9;
